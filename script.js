...
class Factory {
  constructor(make, color, location, airbags, abs, warranty) {
    ...
    class Car extends Factory {
      constructor(model, doors, color, enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof, enginesize, navigation, backupcamera, warranty) {
        super(warranty)
        this.model=model,
        this.doors = doors,
        this.color = color,
    ...
    // Write your code below:
  class Sport extends Car {constructor(model, trim, transmission, top, color, seatstrim, audio, wheelstrim){
      super()
      this.model =  model,
      this.trim =  trim,
      this.transmission =  transmission,
...
let mazda3 = new Car ('mazda3', 4, 'Red', 'hybrid', 'automatic', 'touring', 'base', 'premium', 'leather', true)
    ...
    // Write your code below:
    console.log(mazda3.massBuild(35000, 'Touring'))
...
// {constructor(model, trim, transmission, top, color, seatstrim, audio, wheelstrim)
    ...
    // Write your code below:
console.log(miataP.customerBuild('Black',['hid headlights', 'sports suspension', 'leather steering wheel', 'heated seats', 'adaptive cruise control']))
